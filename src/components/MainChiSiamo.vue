...
<template>
    <section id="chisiamo">
        ...
        <p class="container text-center wdt-80">Opopreparadora nació cuando la sociedad se encontraba en confinamiento,
            adaptándose al teletrabajo y volcando su atención a las redes sociales. <br>
            ...
            distintivas de Opopreparadora es su énfasis en la flexibilidad y la accesibilidad. <br>
            ...
            abrir nuevas puertas y ofrecer soluciones valiosas a las necesidades de la sociedad. Esta academia de
            oposiciones online es un ejemplo inspirador de cómo las ideas pueden florecer en medio de la adversidad y ayudar
            a las personas a alcanzar sus metas educativas y profesionales.
        </p>
    </section>
</template>
